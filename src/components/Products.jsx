    ...
    <>
      <div className="min-h-[100vh] py-20">
        ...
        <section id="Projects"
          ...
          <Link to='/soilrevivers' className="w-72 h-[19rem] object-cover bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl ">
            <a href="#">
          ...
          <Link to='/nutrition' className="w-72 h-[19rem] object-cover bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl ">
            <a href="#">
