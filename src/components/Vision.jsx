  ...
  return (
    <>
      ...
      <div className="flex  gap-4 w-[100%] h-[15rem] bg-cover bg-fixed bg-bottom justify-center items-center m-auto "
        style={{ backgroundImage: "url('https://cdn.shopify.com/s/files/1/0070/7032/files/difference_20between_20mission_20and_20vision.png?v=1699818497')" }} data-aos="zoom-in">
      ...
      <section className="w-full mx-auto py-10 bg-gray-50 dark:bg-gray-900 dark:text-white">
        <div className="xl:w-[80%] sm:w-[85%] xs:w-[90%] mx-auto flex md:flex-row xs:flex-col lg:gap-4 xs:gap-2 justify-center lg:items-stretch md:items-center mt-4">
          <div className="lg:w-[50%] xs:w-full" data-aos="fade-right">
          ...
          <div className="lg:w-[50%] sm:w-full xs:w-full bg-gray-100 dark:bg-gray-900 dark:text-gray-400 md:p-4 xs:p-0 rounded-md" data-aos="fade-left">
        ...
        <div className="xl:w-[80%] sm:w-[85%] xs:w-[90%] mx-auto flex md:flex-row xs:flex-col lg:gap-4 xs:gap-2 justify-center lg:items-stretch md:items-center mt-6" data-aos="fade-right">
          ...
          <div className="md:block sm:hidden xs:hidden lg:w-[50%] xs:w-full" data-aos="fade-left">
