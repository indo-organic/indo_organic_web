    ...
    <>
      ...
      <div className="bg-gray-200">
        ...
        <div className="relative mx-auto  w-full">
          <img className="h-32 w-full object-cover rounded-md object-center" src="https://img.freepik.com/free-vector/different-insects-collection-isolated-white-background_1308-53120.jpg" alt="Random image" />
   ...
   <div className="py-4 bg-transparent ">
        ...
        <div className="w-full ">
          <div className="px-4 py-1 border rounded-lg border-light dark:border-dark-3 shadow-1 dark:shadow-card bg-tg-bg dark:bg-dark-2 sm:px-6 md:px-8 md:py-5">
            <ul className="flex items-center">
              ...
              <Link to='/wheat' className="flex items-center">
                <a
                  href="javascript:void(0)"
              ...
              <li className="text-base font-medium text-primary">INSECTICIDE</li>
            </ul>
          </div>
        </div>
      </div>
    ...
    {/* ends */}
        ...
        <div className="p-1 flex flex-wrap items-center justify-center">
          ...
          <Link to='/indoxam'>
            <InsectCard category="Service" name="INDOXAM" seeMore="see more" sciName='Profenofos 40% EC + Cypermethrin 4% EC'
              imageSrc={indoxamImg}
              imageAlt="alaska" />
          </Link>

          <Link to='/emanate'>
            <InsectCard category="Service" name="Emanate" seeMore="see more" sciName='Profenofos 40% EC + Cypermethrin 4% EC'
              imageSrc={emanateImg}
              imageAlt="alaska" />
          </Link>
