...
const BestSeller = () => {
  return (
    ...
    <h1 className="font-[900] text-7xl mb-1 text-green-800">why us</h1>
  </div>
    <div
  ...
  >
    ...
    <div className="w-full bg-indigo-600 shadow-xl shadow-indigo-200 py-10 px-20 flex justify-between items-center">
      <p className="text-white">
        <span className="text-4xl font-medium">Wants to know more?</span> <br />
        <span className="text-lg">Feel free to contact us</span>
      </p>
      <button className="px-5 py-3 font-medium text-slate-700 shadow-xl hover:bg-white duration-150 bg-yellow-400">Contact Us</button>
    </div>
  </div> */}


<div className="text-center pt-[5rem]">
        <h1 className="font-[900] text-5xl mb-1 text-green-800">why choose us</h1>
      </div>
