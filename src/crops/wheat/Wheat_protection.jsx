   ...
   <div className="py-4 bg-transparent ">
        ...
        <div className="w-full ">
          <div className="px-4 py-1 border rounded-lg border-light dark:border-dark-3 shadow-1 dark:shadow-card bg-tg-bg dark:bg-dark-2 sm:px-6 md:px-8 md:py-5">
            <ul className="flex items-center">
              ...
              <li className="text-base font-medium text-primary">PROTECTION</li>
            </ul>
          </div>
        </div>
      </div>
    ...
    {/* ends */}
        ...
        <div className="p-1 flex flex-wrap items-center justify-center">
          ...
          <Link to='/fungi7'>
            <InsectCard category="Service" name="FUNGI-7" seeMore="see more" sciName='Profenofos 40% EC + Cypermethrin 4% EC'
              imageSrc={fungi7Img}
              imageAlt="alaska" />
          </Link>
...
export default Wheat_protection;