            ...
            <div class="px-12 py-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-blue-600 dark:border-gray-700 dark:hover:border-transparent">
                <div class="flex flex-col sm:-mx-4 sm:flex-row">
                    ...
                    <div class="mt-4 sm:mx-4 sm:mt-0">
                        ...
                        <p class="mt-2 text-gray-500 capitalize dark:text-gray-300 group-hover:text-gray-300"> director</p>
                    </div>
                </div>
            ...
            <div class="px-12 py-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-blue-600 dark:border-gray-700 dark:hover:border-transparent">
                <div class="flex flex-col sm:-mx-4 sm:flex-row">
                    ...
                    <div class="mt-4 sm:mx-4 sm:mt-0">
                        ...
                        <p class="mt-2 text-gray-500 capitalize dark:text-gray-300 group-hover:text-gray-300">product manager</p>
                    </div>
                </div>
            ...
            <div class="px-12 py-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-blue-600 dark:border-gray-700 dark:hover:border-transparent">
                <div class="flex flex-col sm:-mx-4 sm:flex-row">
                    ...
                    <div class="mt-4 sm:mx-4 sm:mt-0">
                        ...
                        <p class="mt-2 text-gray-500 capitalize dark:text-gray-300 group-hover:text-gray-300">sales mananger</p>
                    </div>
                </div>
