...
const Sustain = () => {
    return (
        ...
        <div className="h-screen">
            <div class="xl:max-w-screen-xl pt-6 md:pt-12 pb-6 lg:pb-10 mx-auto px-6 sm:px-6 md:px-8 lg:px-12 xl:pt-24">
                <h1 class="text-3xl md:text-4xl lg:text-6xl xl:text-7xl font-bold mb-6 text-gray-900">
                Advocating for sustainability
                </h1>
                <div class="prose prose-lg lg:prose-xl xl:prose-2xl">
                ...
                <a href="" class="font-semibold mt-6 inline-block text-lg lg:text-xl text-indigo-600 hover:underline"><span
                    class="hidden sm:inline">Discover our key features. »</span>
                    <span class="inline sm:hidden">Learn more »</span>
                </a>
            </div>
