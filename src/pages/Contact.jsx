          ...
          <div class="container flex flex-col items-center gap-16 mx-auto my-32">
            <div class="grid w-full grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
              <div class="flex flex-col items-center gap-3 px-8 py-10 bg-white rounded-3xl shadow-main">
                ...
                <a class="text-lg font-bold text-purple-blue-500" href="mailto:info@indoorganics.in">info@indoorganics.in</a>
              </div>
              <div class="flex flex-col items-center gap-3 px-8 py-10 bg-white rounded-3xl shadow-main">
                <span>
                  <svg xmlns="http://www.w3.org/2000/svg" width="38" height="38" viewBox="0 0 38 38" fill="none">
                ...
                <a class="text-lg font-bold text-purple-blue-500" href="tel:+011-49059099">011-49059099/
              ...
              <div class="flex flex-col items-center gap-3 px-8 py-10 bg-white rounded-3xl shadow-main">
                ...
                <a class="text-lg font-bold text-purple-blue-500 px-5" target="_blank" href="">M3, Aradhana Bhawan, Commercial Complex, Azadpur, Delhi-110033</a>
              </div>
            </div>
          </div>
        </div>
