      ...
      <div className="bg-gray-200">
        ...
        <div className="relative mx-auto  w-full">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <h2 className="text-white text-3xl font-bold">Nutritions </h2>
          </div>
        </div>
   ...
   <div className="py-4 bg-transparent ">
        ...
        <div className="w-full ">
          <div className="px-4 py-1 border rounded-lg border-light dark:border-dark-3 shadow-1 dark:shadow-card bg-tg-bg dark:bg-dark-2 sm:px-6 md:px-8 md:py-5">
            <ul className="flex items-center">
              ...
              <li className="text-base font-medium text-primary">NUTRITION</li>
            </ul>
          </div>
        </div>
      </div>
    ...
    {/* ends */}
        ...
        <div className="p-1 flex flex-wrap items-center justify-center">
          ...
          <Link to='/helperL'>
            <InsectCard category="Service" name="HELPER-L" seeMore="see more" sciName=''
              imageSrc={helperLImg}
              imageAlt="alaska" />
          </Link>

          {/* <Link to='/indomagicImg'>
            <InsectCard category="Service" name="INDO-MAGIC" seeMore="see more" sciName='Profenofos 40% EC + Cypermethrin 4% EC'
              imageSrc={indoMagic}
              imageAlt="alaska" />
          </Link> */}

          {/* <Link to='/automoto'>
            <InsectCard category="Service" name="AUTO-MOTO" seeMore="see more" sciName='Profenofos 40% EC + Cypermethrin 4% EC'
...
export default  Wheat_nutrition;