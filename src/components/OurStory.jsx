              ...
              <div className="relative">
                ...
                <div className="lg:max-w-xl lg:pr-5 relative z-40">
                  ...
                  <div className="mt-10 flex flex-col items-center md:flex-row">
                    ...
                    <Link to='/aboutUs' class="relative inline-flex items-center justify-start px-6 py-3 overflow-hidden font-medium transition-all bg-green-500 rounded-xl group">
                      ...
                      <span class="relative w-full text-left text-white transition-colors duration-200 ease-in-out group-hover:text-white">Know more</span>
                    </Link>
