...
<div className=" relative flex items-center justify-center overflow-hidden bg-gray-200 z-50">
      <div className="relative mx-auto h-full px-4 pb-20 md:pb-10 sm:max-w-xl md:max-w-full md:px-24 lg:max-w-screen-xl lg:px-8">
        <div className="flex flex-col items-center justify-between lg:flex-row py-16">
          <div className="relative">
            <div className="absolute top-0 -left-48 z-0 opacity-70">
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRnbfz0-Uug70XRD4-wemfQ0UZbPZJHySvnO6Oe9E3pxA&s" className="w-36 z-0 h-full object-fill fill-y text-y" alt="Placeholder" />
            </div>
            <div className="lg:max-w-xl lg:pr-5 relative z-40">
              ...
              <h2 className="mb-6 max-w-lg text-5xl font-light leading-snug tracking-tight text-g1 sm:text-7xl sm:leading-snug">
                Quality is never by {' '}
                <span className="my-1 inline-block border-b-8 border-g4 bg-white px-4 font-bold text-g4 animate__animated animate__flash">Chance</span>
              </h2>
          ...
          <div className="relative hidden lg:ml-32 lg:block lg:w-1/2">
            ...
            <div className="abg-orange-400 mx-auto w-fit overflow-hidden rounded-[1rem] rounded-br-none rounded-tl-none ">
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRnbfz0-Uug70XRD4-wemfQ0UZbPZJHySvnO6Oe9E3pxA&s" alt="Placeholder" />
            </div>
          </div>
        </div>
      </div>
