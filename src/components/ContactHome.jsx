            ...
            <section className="bg-green-950">
                <div className="container px-6 py-12 mx-auto">
                    <div className="text-center ">
                        <p className="font-medium text-gray-300">Contact us</p>

                        <h1 className="mt-2 text-2xl font-semibold text-white">We’d love to hear from you</h1>

                        <p className="mt-3 text-gray-500 dark:text-gray-400">Chat to our friendly team.</p>
                    </div>

                    <img className="object-cover w-full h-64 mt-10 rounded-lg lg:h-96" src={contactHome} alt="" />

                    <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-3 sm:grid-cols-2 ">
                        <div className="p-4 rounded-lg bg-blue-50 md:p-6 dark:bg-gray-800 text-center">
                            ...
                            <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">999999=</p>
                        </div>
