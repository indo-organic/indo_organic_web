...
import rukka_title from '../../titleImg/Rukka.png'
const Rukka = () => {
  return (
    <>
        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <div className="h-[460px] rounded-lg  dark:bg-gray-700 mb-4">
              <img className="w-full h-full object-cover" src={rukkaImg} alt="Product Image" />
            </div>
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              <h2 className="text-sm title-font text-gray-500 tracking-widest">
                <img src={rukka_title} alt="" className='w-72 my-4' />
              </h2>
              ...
              <div className="">
                <div className="grid grid-cols-3 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-5 gap-4">
                  ...
                  <div className=" rounded-lg overflow-hidden shadow-md">
                    ...
                    <div className="p-2">
                      <h3 className="text-sm  mb-1">Leaf folder</h3>
