    ...
    <>
      ...
      <div className="bg-white">
        ...
        <div className="relative mx-auto  w-full">
          <img className="h-64 w-full object-cover rounded-md object-bottom" src="https://eos.com/wp-content/uploads/2019/10/crop-protection-1280.jpg" alt="Random image" />
