      ...
      <div class="text-center p-8">
        ...
        <div class="flex flex-wrap items-center mt-20  text-center">
          <div class="w-full md:w-3/5 lg:w-1/2 px-4">
            <img src={about_logo} alt="gem" class="inline-block rounded shadow-lg border border-merino-400" />
          </div>
        ...
        <div class="flex flex-wrap items-center mt-20  text-center">
          <div class="w-full md:w-3/5 lg:w-1/2 px-4">
            <img src="https://sc0.blr1.cdn.digitaloceanspaces.com/article/159143-fyoisazenw-1621239169.jpg" alt="project members" class="inline-block rounded shadow-lg border border-merino-400" />
          </div>
        ...
        <div class="flex flex-wrap items-center mt-20   text-center">
          <div class="w-full md:w-3/5 lg:w-1/2 px-4">
            <img src="https://img.etimg.com/thumb/width-1600,height-900,imgsize-1095102,resizemode-75,msid-77904360/news/economy/agriculture/view-empowering-the-indian-farmer.jpg" alt="editor" class="inline-block rounded shadow-lg border border-merino-400" />
          </div>
          <div class="w-full md:w-2/5 lg:w-1/2 px-4 text-center md:text-left lg:pl-12">
            <p class="sm:text-lg mt-6">
        ...
        <div class="flex flex-wrap items-center mt-20  text-center">
          <div class="w-full md:w-3/5 lg:w-1/2 px-4">
            <img src="https://www.wikihow.com/images/thumb/f/f8/Become-a-Farmer-Without-Experience-Step-1-Version-4.jpg/v4-460px-Become-a-Farmer-Without-Experience-Step-1-Version-4.jpg.webp" alt="bulk editing" class="inline-block rounded shadow-lg border border-merino-400" />
          </div>
          <div class="w-full md:w-2/5 lg:w-1/2 px-4 md:order-first text-center md:text-left lg:pr-12">
